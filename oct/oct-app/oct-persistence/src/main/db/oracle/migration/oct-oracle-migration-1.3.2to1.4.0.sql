...
ALTER TABLE OCT_COUNTRY ADD (
  THRESHOLD NUMBER(10, 0)
);

UPDATE OCT_COUNTRY SET THRESHOLD=14250 WHERE ID=8;
UPDATE OCT_COUNTRY SET THRESHOLD=16500 WHERE ID=5;
UPDATE OCT_COUNTRY SET THRESHOLD=13500 WHERE ID=10;
UPDATE OCT_COUNTRY SET THRESHOLD=4500 WHERE ID=11;
UPDATE OCT_COUNTRY SET THRESHOLD=16500 WHERE ID=19;
UPDATE OCT_COUNTRY SET THRESHOLD=74250 WHERE ID=2;
UPDATE OCT_COUNTRY SET THRESHOLD=9750 WHERE ID=20;
UPDATE OCT_COUNTRY SET THRESHOLD=4500 WHERE ID=21;
UPDATE OCT_COUNTRY SET THRESHOLD=16500 WHERE ID=23;
UPDATE OCT_COUNTRY SET THRESHOLD=40500 WHERE ID=24;
UPDATE OCT_COUNTRY SET THRESHOLD=9750 WHERE ID=22;
UPDATE OCT_COUNTRY SET THRESHOLD=55500 WHERE ID=4;
UPDATE OCT_COUNTRY SET THRESHOLD=16500 WHERE ID=25;
UPDATE OCT_COUNTRY SET THRESHOLD=9000 WHERE ID=29;
UPDATE OCT_COUNTRY SET THRESHOLD=9000 WHERE ID=26;
UPDATE OCT_COUNTRY SET THRESHOLD=54750 WHERE ID=28;
UPDATE OCT_COUNTRY SET THRESHOLD=9000 WHERE ID=12;
UPDATE OCT_COUNTRY SET THRESHOLD=4500 WHERE ID=13;
UPDATE OCT_COUNTRY SET THRESHOLD=6750 WHERE ID=9;
UPDATE OCT_COUNTRY SET THRESHOLD=4500 WHERE ID=14;
UPDATE OCT_COUNTRY SET THRESHOLD=19500 WHERE ID=15;
UPDATE OCT_COUNTRY SET THRESHOLD=38250 WHERE ID=1;
UPDATE OCT_COUNTRY SET THRESHOLD=16500 WHERE ID=16;
UPDATE OCT_COUNTRY SET THRESHOLD=24750 WHERE ID=6;
UPDATE OCT_COUNTRY SET THRESHOLD=15000 WHERE ID=27;
UPDATE OCT_COUNTRY SET THRESHOLD=6000 WHERE ID=18;
UPDATE OCT_COUNTRY SET THRESHOLD=9750 WHERE ID=17;
UPDATE OCT_COUNTRY SET THRESHOLD=54750 WHERE ID=3;
...
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (9, 'REGEXP', 108, NULL, 1);
...
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (23, 'REGEXP', 66, NULL, 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (24, 'REGEXP', 74, NULL, 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (25, 'REGEXP', 155, NULL, 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (26, 'REGEXP', 156, NULL, 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (27, 'REGEXP', 157, NULL, 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (28, 'REGEXP', 158, NULL, 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (29, 'REGEXP', 159, NULL, 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (30, 'REGEXP', 160, NULL, 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (31, 'REGEXP', 161, NULL, 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (32, 'REGEXP', 162, NULL, 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (33, 'REGEXP', 164, NULL, 1);
...
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (36, 'JAVAEXP', 116, NULL, 0);
...
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (50, 'REGEXP', 144, 'oct.property.form.error.id.number.se', 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (51, 'REGEXP', 134, NULL, 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (52, 'REGEXP', 133, NULL, 1);
...
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (61, 'REGEXP', 145, 'oct.property.form.error.id.number.se', 1);
INSERT INTO OCT_LOCAL_RULE (ID, RULETYPE, COUNTRYPROPERTY_ID, ERRORMESSAGE, CANBESKIPPED) VALUES (62, 'REGEXP', 163, NULL, 1);
